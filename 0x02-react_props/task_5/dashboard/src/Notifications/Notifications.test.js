...
it("renders correct list items", () => {
	...
	wrapper.find("ul").forEach((node) => {
		expect(node.equals(<NotificationItem />)).toEqual(true);
	});
...
it("renders correctly when listCourses is not passed", () => {
	...
	expect(wrapper.containsMatchingElement(<li data-notification-type="default">No new notification for now</li>)).toBeTruthy();
});
