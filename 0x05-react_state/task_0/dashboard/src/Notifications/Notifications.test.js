...
describe("Notification tests", () => {
  ...
  it("renders correct list items", () => {
    ...
    expect(wrapper.find("ul").childAt(0).html()).toEqual('<li class="default_9yst8s" data-notification-type="default">New course available</li>');
    expect(wrapper.find("ul").childAt(1).html()).toEqual('<li class="urgent_td2hlt" data-notification-type="urgent">New resume available</li>');
    expect(wrapper.find("ul").childAt(2).html()).toEqual(`<li data-urgent=\"true\" class=\"urgent_td2hlt\">${getLatestNotification()}</li>`);
  });
