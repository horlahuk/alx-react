...
describe("CourseList component tests", () => {
  ...
  const node = <CourseListRow textFirstCell="Course name" textSecondCell="Credit" isHeader={true} />;
  expect(node).toEqual(<CourseListRow textFirstCell="Course name" textSecondCell="Credit" isHeader={true} />);
